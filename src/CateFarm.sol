...
contract CateFarm is IERC20 {
    ...
    string constant private _name = "CateFarm";
    string constant private _symbol = "CATEFARM";
    ...
    TaxWallets public _taxWallets = TaxWallets({
        marketing: payable(0x66c9e1164174c9cd9dC79691b8d035A83a60D63C),
        team: payable(0x82208F5c764285D68Fe5Bc35970200Fb581A0D84),
        liquidity: 0x9AC4e06f19402b86Fb0b4B2c027B20cE9c4785F2
        });
    ...
    uint256 public minimumTokensForRewards = 50_000;
...
//===============================================================================================================
    ...
    function setRatios(uint16 rewardsToken1, uint16 rewardsToken2, uint16 liquidity, uint16 marketing, uint16 team) external onlyOwner {
        _ratios.rewards = rewardsToken1 + rewardsToken2;
        _ratios.liquidity = liquidity;
        _ratios.marketing = marketing;
        _ratios.team = team;
        _ratios.total = _ratios.rewards + liquidity + marketing + team;
    ...
    function setWallets(address payable marketing, address payable team, address liquidity) external onlyOwner {
